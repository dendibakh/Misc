...
{
public:
    BurrowsWheelerDecodeFake(size_t originalStringRow, const std::string& str, std::string& result) : BurrowsWheelerDecode(originalStringRow, str, result) {}
...
TEST(BurrowsWheelerTransformTest, test3_decode)
{
    ...
    BurrowsWheelerTransform BWTransform(str);
    std::string decoded;
    BurrowsWheelerDecode BWDecode(BWTransform.getOriginalStringRow(), BWTransform.getTransformedStr(), decoded);
...
TEST(BurrowsWheelerTransformTest, test3_checkNext)
{
    ...
    BurrowsWheelerTransform BWTransform(str);
    std::string decoded;
    BurrowsWheelerDecodeFake BWDecode(BWTransform.getOriginalStringRow(), BWTransform.getTransformedStr(), decoded);
