...
public:
	...
	void expand(compressedResult::const_iterator begin, const compressedResult::const_iterator& end, std::string& result) const;

	compressedResult::const_iterator constructFromBinaryRepresentation(compressedResult::const_iterator begin, compressedResult::const_iterator end);
