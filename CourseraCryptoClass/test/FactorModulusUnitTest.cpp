...
TEST(FactorModulusUnitTest, 11)
{
        mpz_class cipherText("2209645186741038177630656113488341801741006978789283107173183914367\
        ...
        EXPECT_EQ("Factoring lets us break RSA.", decryptRSA(cipherText, N, e));
}
