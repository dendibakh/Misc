...
class RestoreFolderNoLogging : public Private::RestoreFolder
{
   public:
      RestoreFolderNoLogging(const boost::filesystem::path& binaryPath, const boost::filesystem::path& folderPath) :
                             Private::RestoreFolder(binaryPath, folderPath, false)
      {}
};

class RestoreFolder : public Private::RestoreFolder
{
   public:
      RestoreFolder(const boost::filesystem::path& binaryPath, const boost::filesystem::path& folderPath) :
                    Private::RestoreFolder(binaryPath, folderPath, true)
      {}
};